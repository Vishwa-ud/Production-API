...
const securityMiddleware = async (req, res, next) => {
  try {
    ...
    switch (role) {
      case 'admin':
        limit = 20;
        message = 'Admin request rate limit exceeded (20 per minute). Slow down.';
        break;
      case 'user':
        limit = 10;
        message = 'User request rate limit exceeded (10 per minute). Slow down.';
        break;
      case 'guest':
        limit = 5;
        message = 'Guest request rate limit exceeded (5 per minute). Slow down.';
        break;
    }
